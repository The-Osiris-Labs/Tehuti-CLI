import { costTracker, createStreamingState, getToolCallsFromState, processStreamChunk } from "../../api/index.js";
...
export async function runAgentLoop(
	...
	while (iteration < maxIterations) {
		...
		try {
			...
			const processedCount = await processToolCalls(ctx, toolCallsTyped, {
				onToolCall,
				onToolResult,
				onProgress
			}, signal);
