						...
						showWelcome &&
							React.createElement(
								...
								React.createElement(
									Text,
									{ bold: true, color: GOLD },
									`${ascii ? ASCII_DECORATIVE.ibis : DECORATIVE.ibis} Tehuti v${version || "?"}`,
								),
								React.createElement(
									Box,
									{ marginTop: 1 },
									React.createElement(
										Text,
										{ color: SAND },
										`Model: ${ctxModel || "Unknown"}  Provider: ${normalizedProvider || "Unknown"}`,
									),
								),
								React.createElement(
									Box,
									{ marginTop: 1, flexDirection: "column", justifyContent: "center", alignItems: "center" },
									React.createElement(Text, { color: "gray", bold: true }, "Quick start:"),
									React.createElement(
										Text,
										null,
										"  ",
